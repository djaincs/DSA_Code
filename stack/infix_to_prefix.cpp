...
//Q. infix to prefix expression 

//reverse the string and convert '(' -> ')' & vice versa or just do one thing change '('->')' &vice versa in below algo
//if operand
//print
//if "("
//push to stack
...
//and finally reverse the o/p string to get prefix expression
